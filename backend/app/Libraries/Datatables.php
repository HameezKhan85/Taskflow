  ...
  class Datatables
  {
    ...
    */
    protected function get_paging()
    {
      ...
      $this->ci->db->limit(($iLength != '' && $iLength != '-1')? $iLength : 1000, ($iStart)? $iStart : 0);
    }
    ...
    */
    ...
    {
       $first_col = $this->ci->input->post('iSortCol_0');
       $first_order = $this->ci->input->post('sSortDir_0');
     ...
     if(isset($_POST['CustomSort']) and $_POST['CustomSort']!='' and isset($first_col) and $first_col=='1'){
		 $this->ci->db->order_by($_POST['CustomSort'], $first_order);	 
     }
     else{
